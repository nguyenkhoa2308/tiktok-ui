export const BlueVCheck = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PrimaryVCheck = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const WhitePlusIcon = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const AnalyticsIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const CreatorToolsIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PromotePostIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const VideosIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const RepostsIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const CollectedIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 24 24"
...
export const UncollectedIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 24 24"
...
export const LikedIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        ...
        height={height}
    >
        <path d="M24 12.19c-4.36-4.78-11.05-4.84-15.29-.63a10.82 10.82 0 0 0 0 15.38l14.23 14.12a1.5 1.5 0 0 0 2.12 0l14.23-14.12a10.82 10.82 0 0 0 0-15.38c-4.24-4.2-10.93-4.15-15.29.63Zm-2.01 2.25.03.04.92.91a1.5 1.5 0 0 0 2.12 0l.92-.91.03-.04c3.25-3.78 8.11-3.78 11.17-.75a7.82 7.82 0 0 1 0 11.12L24 37.89 10.82 24.8a7.82 7.82 0 0 1 0-11.12c3.06-3.03 7.92-3.03 11.17.75Z"></path>
    </svg>
);

export const PrimaryLikeIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const LikeSolidIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        viewBox="0 0 24 24"
        className={className}
        fill="currentColor"
...
export const PrivateLikedIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const MutedIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="#fff"
        viewBox="0 0 48 48"
...
export const UnmutedIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="#fff"
        viewBox="0 0 48 48"
...
export const CommentIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg className={className} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={width} height={height}>
        <path
            fillRule="evenodd"
